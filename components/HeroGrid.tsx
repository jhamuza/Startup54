...
const HeroGrid: React.FC = () => {
    return (
        <div className="grid grid-cols-1 gap-6 @[1024px]:grid-cols-3 @[1024px]:grid-rows-3">
            {/* Main Hero Card */}
            <div className="group relative flex min-h-[300px] flex-col justify-between overflow-hidden rounded-2xl p-6 card-shadow-doodle card-border @[1024px]:col-span-2 @[1024px]:row-span-2 rotate-small rotate-v1">
                {/* Background Image */}
                <div 
                ...
                <div className="relative z-10 mt-auto pt-6">
                    <h2 className="font-heading text-3xl font-bold leading-tight text-[var(--text-color)] mb-2">Event Starts January 9, 2026</h2>
                    <CountdownTimer />
                </div>
            </div>
            ...
            {/* Venue Card (Formerly Abstract Image Card) */}
            <div className="group relative flex min-h-[200px] flex-col justify-end overflow-hidden rounded-2xl p-6 card-shadow-doodle card-border rotate-small rotate-v1">
                {/* Background Image */}
                <div 
                    className="absolute inset-0 z-0 bg-cover bg-center transition-transform duration-700 group-hover:scale-105" 
                ...
                <div className="relative z-10 w-full">
                     <h2 className="font-heading text-3xl font-bold leading-tight text-white drop-shadow-sm">Venue: TEGAS Digital Village</h2>
                </div>
            </div>
